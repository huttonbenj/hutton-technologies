    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-2xl font-bold mb-4">Hutton Technologies</h3>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a
                href="mailto:contact@huttontech.com"
                className="bg-gray-800 p-3 rounded-lg hover:bg-primary-600 transition-colors"
              >
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
          <p>&copy; {currentYear} Hutton Technologies. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
